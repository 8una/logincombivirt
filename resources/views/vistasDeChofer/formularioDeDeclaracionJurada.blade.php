...
<body>
    ...
    @section('content')
        ...
        <form  method="POST" action="{{route('cargoDeclaracionJurada')}}"class="m-2 p-2">
        @csrf
        ...
        <input class="form-control w-25" type="text" name="DNI" value="{{$viajante->dni}}" aria-label="readonly input example" readonly>
